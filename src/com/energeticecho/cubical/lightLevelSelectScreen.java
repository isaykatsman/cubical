...
public class lightLevelSelectScreen extends GLScreen {
	//create all vars
	Camera2D guiCam;
	...
	public lightLevelSelectScreen(Game game) {
		super(game);
	...
	public void present(float deltaTime) {
		...
		//present light level select screen
